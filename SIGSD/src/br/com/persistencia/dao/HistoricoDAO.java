...
public class HistoricoDAO extends GenericDAO{
	...
	private static final String historicoListar = "SELECT h.idHistorico,sv.nome as nomeServico,sl.data,sl.periodo,sl.statusAtual,h.status,p.nome as nomeFuncionario,n.idNota,n.descricao, precoVisita,sl.idSolicitacao,pf.descricao as perfil, sum(valor/2)+precovisita as total FROM historico h " +
