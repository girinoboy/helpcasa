...
//	private Clientes cliente1=new Clientes();
	...
	private String instrucao3="APOS O VENCIMENTO N�O APLICAR DESCONTO";
	private String instrucao4="APOS O VENCIMENTO COBRAR R$ 1.50 DE TAXA DE OPERA��O ";
	private String instrucao5="ANTES DO VENCIMENTO APLICAR DESCONTO DE 5%";
	private String descricao1="Boleta referente a cobran�a de servi�os prestados. ";
	private String descricao2="Os servi�os do SIGSD foram encerrados no dia 25/05/2009";
...
/*
	...
	public void carregaClientes(){
	 ...
	 String[] nomes={"Loja de Doces","Mercearia Tia Joana","Fazenda Jo�o Soares"} ;
	 ...
	 String[] rua={"Av. 21 de Abril","Av. Afonso Pena", "Av. Concei��o Barbosa"};
